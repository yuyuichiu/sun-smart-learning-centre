    ...
    <main>
      ...
      <main className={`${styles.main}`}>
        <section id='about' className='my-5 container'>
          <h2 className={`${styles.aboutUsTxt} ${aboutAnimation ? styles.active : ''} m-4 text-center fw-bold`}>關於我們</h2>
          <div className='row'>
            <p className={`col-md-6 col-12 ${styles.aboutUsTxt} ${aboutAnimation ? styles.active : ''}`}>
              本中心成立十五年，為社區學生提供補習。我們集合最具教學經驗的老師，致力為學生提供一系列多元化又優質的課程，緊貼家長與同學的需求。我們緊貼現今教育模式，提供專為學生而設的全方位學習，全面提升學生們的啟發能力與主動學習精神、培訓應試技巧，讓他們輕鬆面對考試，得到最佳成績。過去，我們的學生皆於我們的教導下成功取得優異進步，這些過往的例子就是本中心的硬實力的最佳證明。
            </p>
            <p className={`col-md-6 col-12 ${styles.aboutUsTxt} ${aboutAnimation ? styles.active : ''}`}>
              我們為不同程度的中小學生提供一系列的學科課程，包括功課輔導班與各科專科班，以小組形式授課，於學校進度同步教授，派發中心獨家筆記以及教授獨門技巧，所有的練習亦均由導師親自批改，大大減低誤改的機會。我們亦會注重學生的學習進度，以由淺入深的方式教授，使不同程度的學員都能易於明白課題知識，體會學習的成功！
            </p>
          </div>
        </section>
        ...
        <section id='schools' className='mb-5 container text-center' ref={logosEl}>
          <div className={`row ${styles.schoolLogo} ${logoAnimation ? styles.active : ''}`}>
            ...
            <div className={`d-flex justify-content-center col-6 col-md-3 my-2`}>
              <img src='/assets/school1.jpg' height={110} width={100} title='天水圍天主教小學' />
            </div>
            <div className={`d-flex justify-content-center col-6 col-md-3 my-2`}>
              <img src='/assets/school2.jpg' height={110} width={100} title='崇德英文學院' />
            </div>
            <div className={`d-flex justify-content-center col-6 col-md-3 my-2`}>
              <img src='/assets/school3.jpg' height={110} width={100} title='香港青年協會李兆基書院' />
            </div>
            <div className={`d-flex justify-content-center col-6 col-md-3 my-2`}>
              <img src='/assets/school4.jpg' height={110} width={100} title='十八鄉鄉事委員會公益社小學' />
            </div>
          </div>
        ...
        <section id='classes' className='mb-5' ref={classesEl}>
            ...
            <div className='container position-relative'>
              <div className={`${styles.imageBox}`} >
                <div className={`${styles.imageContainer}`}>
                  <img src='/assets/parent-helping-child-asian.jpg' alt='decoration'/>
                </div>
              </div>
              <h3>小學功課輔導班</h3>
          ...
          <article className={`${styles.classes} ${classesAnimation ? styles.active : ''}`}>
            <div className='container position-relative'>
              <div className={`${styles.imageBox}`} >
                <div className={`${styles.imageContainer}`}>
                  <img src='/assets/smiling-students.jpg' alt='decoration'/>
                </div>
              </div>
              <h3>中小學專科班</h3>
          ...
          <article className={`${styles.classes} ${classesAnimation ? styles.active : ''}`}>
            <div className='container position-relative'>
              <div className={`${styles.imageBox}`} >
                <div className={`${styles.imageContainer}`}>
                  <img src='/assets/hardworking-student.webp' alt='decoration'/>
                </div>
              </div>
              <h3>中學輔導及溫習班</h3>
          ...
          <article className={`container-md`}>
            ...
            <div className={`${styles.others} ${othersAnimation ? styles.active : ''}`} ref={othersEl}>
              ...
              <aside className={`${styles.imageBox}`} >
                <div className={`${styles.imageContainer}`}>
                  <img src='/assets/smiling-student-asian.jpg' alt='decoration'/>
                </div>
              </aside>
            </div>
